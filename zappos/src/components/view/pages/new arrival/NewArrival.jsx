      ...
      >
        ...
        <div className="">
            ...
            <div className="relative z-10 bg-white bg-opacity-80 p-4 mt-[380px] flex text-left">
              <dl className="space-y-4">
                <div>
                    <button type="button" onClick={hanldeImage}><img src={isShoeBlack?IMAGES.miaZommedIn:IMAGES.miaZommedOut} alt="" className="w-10 rounded-full " /></button>
                </div>
                <div>
...

{
  /* <SwiperSlide>
    ...
    <SwiperSlide>
    <img src={IMAGES.kendraScottSecond} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.adriannaPapellZommedIn} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.adriannaPapellZommedOut} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.blueByBetseyJohnsonFirst} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.blueByBetseyJohnsonSecond} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.pumaFirst} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.pumaSecond} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.donaldPlinerSecond} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.donaldPlinerfirst} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.steveMaddenfirst} alt="2" />
    </SwiperSlide>

    <SwiperSlide>
    <img src={IMAGES.steveMaddenSecond} alt="2" />
    </SwiperSlide>
     */
}
